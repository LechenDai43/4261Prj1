    ...
    class RenderFriend extends AsyncTask<String, String, String> {
            ...
            if (searchBarTextFieldHm != null) {
                ...
                if (key == null || key.length() < 1 || key.equals("Enter a friend name...")) {
                    try {
                        ...
                        String post_data = URLEncoder.encode("f1", "UTF-8") + "=" + URLEncoder.encode("true", "UTF-8") + "&" +
                    ...
                    /*
                    Todo...
                    1. fill in the logic to query friends based on search
                     */
                }
            }
            return null;
        ...
        protected void onPostExecute(String args) {
            if (context != null && myListView != null) {
                ...
                System.out.println(myListView.getChildCount() + " Look Here");
